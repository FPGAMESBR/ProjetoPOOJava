...
import YearDetails from './YearDetails.js';
    ...
    <Router>
      <div className="container">
        ...
        <div className="content">
          <div className="top">
            <Link to="/Year" className="button"><i className="fas fa-calendar-alt"></i> Anos</Link>
            <Link to="/" className="button"><i className="fas fa-graduation-cap"></i> Professores</Link>
            <Link to="/" className="button"><i className="fas fa-book-open"></i> Disciplinas</Link>
          </div>
          <Routes>
